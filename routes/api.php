...
Route::get('/school/user/teachers-class/{id}/{year}',[UserController::class,'teacher_class']);
Route::get('/school/user/students-class/{id}/{year}',[UserController::class,'student_class']);
